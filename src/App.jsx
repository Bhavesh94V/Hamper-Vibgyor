  ...
  const hampers = [
    {
      ...
      story:
        "Crafted in the heart of Belgium, each chocolate tells a story of tradition and excellence. Our master chocolatiers have perfected these recipes over generations.",
    ...
    },
    {
      ...
      features: ["All Natural Ingredients", "No Artificial Flavors", "Sustainably Sourced", "Resealable Packaging"],
      gallery: [
      ...
      story:
        "Sourced from the finest farms around the world, each snack is carefully selected for its exceptional quality and taste.",
    ...
    },
    {
      ...
      features: ["Single Origin Teas", "Hand-picked Leaves", "Traditional Processing", "Premium Tea Accessories"],
      gallery: [
      ...
      story:
        "From the misty mountains of Darjeeling to the ancient tea gardens of China, each blend represents centuries of tea-making tradition.",
    ...
    },
    {
      ...
      features: ["Traditional Recipes", "Pure Ghee", "No Artificial Colors", "Fresh Daily Preparation"],
      gallery: [
      ...
      story:
        "Prepared using age-old family recipes passed down through generations, each sweet carries the essence of Indian tradition and celebration.",
    ...
    },
    {
      ...
      features: ["100% Organic", "No Pesticides", "Sustainably Sourced", "Health Benefits Certified"],
      gallery: [
      ...
      story:
        "Sourced from organic farms committed to sustainable practices, each product supports both your health and the environment.",
    ...
    },
    {
      ...
      features: ["Single Origin Beans", "Freshly Roasted", "Fair Trade Certified", "Professional Equipment"],
      gallery: [
      ...
      story:
        "From the highlands of Ethiopia to the mountains of Colombia, each bean is carefully selected and roasted to perfection by our master roasters.",
        ...
        <div className="text-center max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 max-w-6xl mx-auto">
            {categories.map((category, index) => (
              <div
                key={index}
                className="group bg-white/90 backdrop-blur-lg rounded-3xl p-8 text-center hover:bg-white transition-all duration-500 hover:scale-110 cursor-pointer border border-gray-100 shadow-lg hover:shadow-2xl transform hover:-translate-y-2"
              >
                <div
                  className={`bg-gradient-to-r ${category.color} rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-white group-hover:scale-110 transition-transform duration-300`}
                >
                  {category.icon}
                </div>
      ...
      <section ref={productsRef} className="relative z-10 py-32 px-4 parallax-section ">
        <div className="max-w-8xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-7xl font-bold text-[#7A7A7A] mb-6">Premium Collections</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 ">
            {hampers.map((hamper) => (
              <div
                key={hamper.id}
                className="product-card group  bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-3xl transition-all duration-700 transform hover:-translate-y-4 border border-gray-50 relative"
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-2 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-5 h-5 ${i < Math.floor(hamper.rating) ? "fill-[#b89433] text-[#b89433]" : "text-gray-300"}`}
                      />
                    ))}
                  ...
                  <p className="text-[#7A7A7A] text-lg mb-6 line-clamp-2 leading-relaxed">{hamper.description}</p>
      ...
      <section className="relative z-10 py-32 px-4 bg-gradient-to-br from-[#b89433]/5 via-white to-[#c87c38]/5 parallax-section">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-[#3A2F25] max-w-3xl mx-auto">
            ...
            {[
              {
                ...
                desc: "Only the finest products make it into our collections",
              },
              {
                icon: <Package className="w-12 h-12" />,
                title: "Elegant Packaging",
                desc: "Beautiful presentation that makes every gift special",
              },
              {
              ...
              },
              {
                ...
                desc: "100% satisfaction guaranteed or money back",
              },
            ].map((feature, index) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:scale-105"
              >
            ...
            {[
              {
                step: "01",
                title: "Curate",
                desc: "Expert selection of premium products",
                icon: <Crown className="w-8 h-8" />,
              },
              {
                step: "02",
                title: "Package",
                desc: "Beautiful presentation and packaging",
              ...
              <div key={index} className="text-center relative">
                ...
                <div className="text-[#b89433] mb-4 flex justify-center">{process.icon}</div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white/95 backdrop-blur-sm p-6 border-b border-gray-100 flex justify-between items-center rounded-t-3xl">
              ...
              <button onClick={closeHamperDetail} className="p-3 hover:bg-gray-100 rounded-full transition-colors">
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                  <div className="mb-6">
                    <img
                      src={selectedHamper.gallery[activeImageIndex] || "/placeholder.svg"}
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {selectedHamper.gallery.map((image, index) => (
                      <button
                        ...
                        className={`h-20 rounded-lg overflow-hidden border-2 transition-all ${activeImageIndex === index ? "border-[#b89433]" : "border-gray-200"
                          }`}
                      >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-5 h-5 ${i < Math.floor(selectedHamper.rating) ? "fill-[#b89433] text-[#b89433]" : "text-gray-300"}`}
                      />
                    ))}
